...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed right-4 md:right-6 md:!bottom-6 z-50 flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_20px_rgba(37,211,102,0.45)] transition-transform duration-200 hover:scale-110 hover:shadow-[0_6px_28px_rgba(37,211,102,0.55)]"
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="h-6 w-6 md:h-7 md:w-7" fill="white">
